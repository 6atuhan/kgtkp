<template >
    <div class="flex items-center justify-center w-screen h-screen">
        <details class="list-none h-56 md:w-[500px]">
            <summary class="text-5xl my-10 sm:text-5xl md:text-8xl select-none font-extrabold leading-10 text-white text-outline transition-all ">
                <h1 class="cursor-pointer" >K G T K P</h1>
            </summary>
            <form @submit.prevent="loginFunc" class="flex flex-col sm:flex-col justify-center items-center md:flex-row " >
        ...
        <p class="text-zinc-400 text-center">hesabınız yoksa <br> mail: <strong>admin@admin.com</strong> şifre: <strong>admin123</strong></p>
        </details>
    </div>
