...
<h1 @click="goHome" class="text-5xl cursor-pointer shine select-none text-center font-extrabold leading-10 text-white my-16 sm:my-16 text-outline md:fixed md:top-2 md:left-2 md:my-0 ">K G T K P</h1>
